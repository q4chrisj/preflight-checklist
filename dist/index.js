...
const regex_patterns_1 = __nccwpck_require__(3907);
...
const parameters_1 = __nccwpck_require__(8054);
__nccwpck_require__(3985).suppress = true;
async function run() {
    ...
    const Tests = new Map();
    Tests.set("platform-studio-eds", path_1.default.join(__dirname, "../test_data/studio-eds-ssm.tf"));
    ...
    for (let [key, value] of Tests) {
        let found_parameters = (0, files_1.findMatchesInFiles)([value], key);
...
const ssm_1 = __importDefault(__nccwpck_require__(3380));
...
Object.defineProperty(apiLoader.services['ssm'], '2014-11-06', {
  get: function get() {
    var model = __nccwpck_require__(7667);
    model.paginators = __nccwpck_require__(4951)/* .pagination */ .o;
    model.waiters = __nccwpck_require__(315)/* .waiters */ .V;
    return model;
  },
  enumerable: true,
  configurable: true
...
var util = {
  ...
  uuid: {
    v4: function uuidV4() {
      return __nccwpck_require__(7821).v4();
    }
  },
...
var _v = _interopRequireDefault(__nccwpck_require__(7668));

var _v2 = _interopRequireDefault(__nccwpck_require__(8573));

var _v3 = _interopRequireDefault(__nccwpck_require__(7811));

var _v4 = _interopRequireDefault(__nccwpck_require__(6508));
...
var _rng = _interopRequireDefault(__nccwpck_require__(9788));

var _bytesToUuid = _interopRequireDefault(__nccwpck_require__(5827));
...
var _v = _interopRequireDefault(__nccwpck_require__(6097));

var _md = _interopRequireDefault(__nccwpck_require__(3525));
...
var _sha = _interopRequireDefault(__nccwpck_require__(7387));
